    ...
    return (
        <div className="dropdown mx-2 drop-nav">
            <button className="btn dropdown-toggle btn1-nav" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div className='loggedInText-nav text-center'>{localStorage.getItem("username")}</div>
            </button>

            <ul className="dropdown-menu">
                <li><button onClick={onLogoutHandler} className="dropdown-item">Logout</button></li>
            </ul>
        </div>
